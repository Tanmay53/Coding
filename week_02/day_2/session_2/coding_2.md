...
1. Inherited
```
'color' 'font-size' 'text-align' 'font-weight' 'visibility' 'z-index' 'clear'
```
2. Non-Inherited
```
'padding' 'margin' 'background-color' 'border' 'display' 'float' 'height' 'width' 'overflow' 'word-wrap' 'position' 
```
